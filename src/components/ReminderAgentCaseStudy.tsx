...
export function ReminderAgentCaseStudy({
    onBack,
}: ReminderAgentCaseStudyProps) {
    return (
                    ...
                    <div className="max-w-5xl mx-auto bg-white rounded-3xl p-8 shadow-2xl">
                        <div className="text-right">
                            <p className="text-xl text-neutral-700 leading-relaxed mb-4">
                                ...
                                یک دستیار هوشمند برای مدیریت داشبورد کسب‌وکار
                                است که با استفاده از تکنولوژی‌های پیشرفته هوش
                                مصنوعی طراحی شده است.
                            </p>
                            <p className="text-lg text-neutral-600 leading-relaxed">
                                این پروژه با هدف کمک به کاربران در مدیریت بهتر
                                کسب‌وکار و افزایش بهره‌وری از طریق دستیار صوتی و
                                متنی طراحی شده است. چالش اصلی طراحی تجربه‌ای
                                ساده و طبیعی برای تعامل با هوش مصنوعی بود.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="bg-gradient-to-br from-[#1F1BF5]/5 to-[#1F1BF5]/10 rounded-3xl p-8 border-r-4 border-[#1F1BF5]">
                        <p className="text-xl text-neutral-700 leading-relaxed text-right mb-6">
                            چت‌باتی مبتنی بر هوش مصنوعی که به صاحبان کسب‌وکارها
                            کمک می‌کند تا به‌راحتی کارهای خود را در داشبورد
                            انجام دهند. از طریق دستورات ساده صوتی یا متنی،
                            کاربران می‌توانند وظایف را مدیریت کنند، به اطلاعات
                            دسترسی داشته باشند و بدون پیچیدگی رابط‌های کاربری،
                            اقدامات مورد نظر خود را انجام دهند.
                        </p>
                ...
                >
                    ...
                    <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-3xl p-8 border-r-4 border-red-500">
                        <p className="text-2xl text-neutral-800 leading-relaxed text-right mb-4">
                            صاحبان کسب‌وکار معمولاً داشبوردها را پیچیده و
                            وقت‌گیر می‌یابند.
                        </p>
                        <p className="text-xl text-neutral-700 leading-relaxed text-right">
                            این امر منجر به احساس ناامیدی می‌شود و آن‌ها را از
                            تمرکز بر کسب‌وکارشان باز می‌دارد.
                        </p>
                    </div>
                </motion.section>
                ...
                >
                    ...
                    <div className="bg-gradient-to-br from-[#1F1BF5]/5 to-blue-50 rounded-3xl p-8">
                        <p className="text-xl text-neutral-700 leading-relaxed text-right mb-8">
                            این چت‌بات هدف دارد راهی ساده برای تعامل کاربران با
                            داشبوردها از طریق دستورات صوتی یا متنی فراهم کند.
                            این ابزار به کاربران کمک می‌کند تا وظایف خود را
                            سریع‌تر انجام دهند، از سردرگمی جلوگیری کرده و
                            بهره‌وری را بهبود ببخشند.
                        </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="bg-white rounded-2xl p-6 border-r-4 border-[#1F1BF5]">
                                <div className="flex items-start gap-3 justify-start">
                                    ...
                                    <p className="text-lg text-neutral-700 text-right flex-1 leading-relaxed">
                                        زمان و بار کاری را در مقایسه با جستجوی
                                        دستی کاهش می‌دهد
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-6 border-r-4 border-[#1F1BF5]">
                                <div className="flex items-start gap-3 justify-end">
                                    ...
                                    <p className="text-lg text-neutral-700 text-right flex-1 leading-relaxed">
                                        مناسب برای کاربران غیر فنی بدون نیاز به
                                        درک ساختار داشبورد
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-6 border-r-4 border-[#1F1BF5]">
                                <div className="flex items-start gap-3 justify-end">
                                    ...
                                    <p className="text-lg text-neutral-700 text-right flex-1 leading-relaxed">
                                        افزایش اعتماد از طریق شفافیت و مدیریت
                                        خطا
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-6 border-r-4 border-[#1F1BF5]">
                                <div className="flex items-start gap-3 justify-end">
                                    ...
                                    <p className="text-lg text-neutral-700 text-right flex-1 leading-relaxed">
                                        صرفه‌جویی در زمان با خودکارسازی وظایف
                                        تکراری
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 justify-end mb-4">
                                ...
                                <div className="text-right flex-1">
                                    ...
                                    <p className="text-neutral-700 leading-relaxed">
                                        کاربران اغلب در پیدا کردن قابلیت‌ها یا
                                        بخش‌های مناسب در داشبورد به دلیل طراحی
                                        پیچیده آن دچار مشکل می‌شوند.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-lg">
                            <div className="flex items-start gap-4 justify-end mb-4">
                                ...
                                <div className="text-right flex-1">
                                    ...
                                    <p className="text-neutral-700 leading-relaxed">
                                        انجام دستی وظایف روتین یا تکراری ممکن
                                        است ناکارآمد و برای کاربران خسته‌کننده
                                        باشد.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-lg">
                            <div className="flex items-start gap-4 justify-end mb-4">
                                ...
                                <div className="text-right flex-1">
                                    ...
                                    <p className="text-neutral-700 leading-relaxed">
                                        کاربران غیر فنی ممکن است به دلیل ساختار
                                        داشبورد دچار سردرگمی شده و با خطاها یا
                                        تأخیرهای مکرر روبه‌رو شوند.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-lg">
                            <div className="flex items-start gap-4 justify-end mb-4">
                                ...
                                <div className="text-right flex-1">
                                    ...
                                    <p className="text-neutral-700 leading-relaxed">
                                        کاربران ممکن است با مدیریت همزمان وظایف
                                        متعدد بدون راهنمایی شفاف احساس فشار
                                        کنند.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="bg-gradient-to-br from-[#1F1BF5]/5 to-purple-50 rounded-3xl p-8 border-r-4 border-[#1F1BF5]">
                        <div className="mb-8">
                            <p className="text-lg text-neutral-700 leading-relaxed text-right">
                                برای دستیابی به درک جامع از نیازها و دغدغه‌های
                                کاربران، تحقیقات اولیه و ثانویه انجام شد. این
                                رویکرد فراگیر مشارکت‌کنندگانی با پیشینه‌های
                                متنوع را در بر گرفته است.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-lg mb-6">
                            ...
                            <div className="bg-gradient-to-br from-neutral-50 to-neutral-100 rounded-2xl p-6">
                                <p className="text-lg text-neutral-700 leading-relaxed text-right">
                                    علی مالک یک کسب‌وکار کوچک اما در حال رشد در
                                    حوزه سلامت است. او در کمک به مراجعان برای
                                    دستیابی به تعادل بهتر بین کار و زندگی و
                                    بهبود سلامت روانی تخصص دارد. با وجود علاقه
                                    به کارش،{" "}
                                    <span className="text-[#1F1BF5]">
                                        مدیریت بخش‌های کسب‌وکار مانند مدیریت
                                        کاربران، پیگیری مالی و به‌روزرسانی خدمات
                                    </span>{" "}
                                    برای او چالش‌برانگیز و پراسترس است.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="space-y-4">
                                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-4">
                                    <p className="text-neutral-700 text-right leading-relaxed">
                                        💭 کاش کسی بود که تمام این کارهای اداری
                                        را برای من انجام می‌داد
                                    </p>
                                </div>
                                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-4">
                                    <p className="text-neutral-700 text-right leading-relaxed">
                                        💭 اگر در داشبورد اشتباه کنم، آیا
                                        اطلاعات کسب‌وکارم به مشکل می‌خورد؟
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-lg">
                            ...
                            <div className="space-y-4">
                                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-4">
                                    <p className="text-neutral-700 text-right leading-relaxed">
                                        😔 احساس ناامیدی وقتی نمی‌تواند سریع
                                        چیزی را که نیاز دارد پیدا کند
                                    </p>
                                </div>
                                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-4">
                                    <p className="text-neutral-700 text-right leading-relaxed">
                                        😰 احساس فشار زمانی که با گزینه‌ها و
                                        دکمه‌های متعدد روبه‌رو می‌شود
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-lg">
                            ...
                            <div className="space-y-4">
                                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-4">
                                    <p className="text-neutral-700 text-right leading-relaxed">
                                        🖱️ به امید پیدا کردن گزینه صحیح به صورت
                                        تصادفی روی گزینه‌ها کلیک می‌کند
                                    </p>
                                </div>
                                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-4">
                                    <p className="text-neutral-700 text-right leading-relaxed">
                                        🤝 از اعضای تیم کمک می‌گیرد یا در
                                        اینترنت جستجو می‌کند
                                    </p>
                                </div>
                                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-4">
                                    <p className="text-neutral-700 text-right leading-relaxed">
                                        ⏰ منصرف می‌شود و تصمیم می‌گیرد بعداً
                                        برگردد اما اغلب فراموش می‌کند
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-neutral-200 shadow-lg">
                            ...
                            <div className="space-y-4">
                                <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-4">
                                    <p className="text-neutral-700 text-right leading-relaxed">
                                        💬 "کاش می‌توانستم به سیستم بگویم چه
                                        کاری انجام دهد"
                                    </p>
                                </div>
                                <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-4">
                                    <p className="text-neutral-700 text-right leading-relaxed">
                                        💬 "چرا این کار این‌قدر مراحل دارد؟ باید
                                        آسان‌تر باشد"
                                    </p>
                                </div>
                                <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-4">
                ...
                >
                    <div className="bg-gradient-to-br from-[#1F1BF5] to-[#1F1BF5]/80 rounded-3xl p-8 text-white">
                        ...
                        <p className="text-xl leading-relaxed text-right mb-6">
                            با درک عمیق از چالش‌های علی و کاربران مشابه، چت‌بات
                            هوش مصنوعی طراحی شد که:
                        </p>
                        <div className="grid md:grid-cols-2 gap-4">
                            <div className="bg-white/10 rounded-2xl p-6">
                                <p className="text-lg leading-relaxed text-right">
                                    🎯 به‌جای پیمایش در منوها، کافیست بگوید یا
                                    بنویسد چه کاری نیاز دارد
                                </p>
                            </div>
                            <div className="bg-white/10 rounded-2xl p-6">
                                <p className="text-lg leading-relaxed text-right">
                                    ⚡ وظایف تکراری را به‌صورت خودکار انجام
                                    می‌دهد
                                </p>
                            </div>
                            <div className="bg-white/10 rounded-2xl p-6">
                                <p className="text-lg leading-relaxed text-right">
                                    🛡️ با راهنمایی واضح، احتمال خطا را کاهش
                                    می‌دهد
                                </p>
                            </div>
                            <div className="bg-white/10 rounded-2xl p-6">
                                <p className="text-lg leading-relaxed text-right">
                                    💡 بدون نیاز به یادآوری محل تنظیمات، همه چیز
                                    در دسترس است
                                </p>
                            </div>
                        </div>
